<div class="form_container">
    ...
    <?php include 'layouts/entry_page/phone_verification_form.php'; ?>
    ...
    <div class="submit_form">
        ...
        <span class="phone_verification_form form_element d-none" form="phone_verification_form"><?php echo Registry::load('strings')->verify ?></span>
    </div>
    ...
    <div class="change_form ">
        <div>
            ...
            <span class="switch_form d-none form_element verify_phone_number" form="phone_verification">
                <?php echo Registry::load('strings')->verify ?>
            </span>
