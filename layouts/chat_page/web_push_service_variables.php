    ...
    if (!empty(Registry::load('settings')->push_notifications) && Registry::load('settings')->push_notifications !== 'disable') {
        ...
        <div class="web_push_service_variables d-none">
            ...
            if (Registry::load('settings')->push_notifications === 'webpushr') {
                ...
                ?>
                <span class='apiKey'><?php echo (Registry::load('settings')->fb_apikey) ?></span>
                <span class='authDomain'><?php echo (Registry::load('settings')->fb_authdomain) ?></span>
                <span class='projectId'><?php echo (Registry::load('settings')->fb_projectid) ?></span>
                <span class='messagingSenderId'><?php echo (Registry::load('settings')->fb_messagingsenderid) ?></span>
                <span class='appId'><?php echo (Registry::load('settings')->fb_appid) ?></span>
                <?php
            } ?>
